function prog() {
	var a = document.getElementById('a').value;  //getElementById()возвращает Element объект, представляющий элемент, idсвойство которого соответствует указанной строке.
